...
c      path1 = '/data1/ylchen/DATA_old/ERA40/'
c      path2 = '/data1/ylchen/DATA_out/DM_CLT/'
      path1 = '/walker2/ylchen/DATA_old/ERA40/'
      path2 = '/walker2/ylchen/DATA_out/mon/DM/'
      ...
      open (21,file=path2//'ERA40_DM_TP300_'//year//'_mon_'//cas//'.bin'
...
c    &,status='unknown',form='unformatted',access='direct',recl=nx*ny)
      if (iop.ge.2)
     &   open (29,file=path2//'ERA40_CLB_'//year//'_pnt_'//cas//'.bin'
     &,status='unknown',form='unformatted',access='direct',recl=4*nx*ny)
...
c***********************************************************************
      ...
      if (iop.ge.2) then
         fn(1) = path1//'sfc/2T/ERA40_2T_SFC_1958_2001_mon.bin'
         fn(2) = path1//'sfc/2D/ERA40_2D_SFC_1958_2001_mon.bin'
         fn(3) = path1//'sfc/MSL/ERA40_MSL_SFC_1958_2001_mon.bin'
...
c***********************************************************************
 ...
 800  continue
      ...
      print *,'Delta Mq(73,37)',deltamq(73,37)
      print *,'k-top=',top(73,37)
      print *,'k-bot=',bot(73,37)

      write (21,rec=itm) ((deltam(i,j),i=1,nx),j=1,ny)
c      write (22,rec=itm) ((deltamq(i,j),i=1,nx),j=1,ny)
c      write (23,rec=itm) ((top(i,j),i=1,nx),j=1,ny)
